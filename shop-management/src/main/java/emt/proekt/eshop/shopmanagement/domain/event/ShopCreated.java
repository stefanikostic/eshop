package emt.proekt.eshop.shopmanagement.domain.event;
...
import emt.proekt.eshop.shopmanagement.domain.model.UserId;
...
@Getter
public class ShopCreated implements DomainEvent {
    @JsonProperty("shopId")
    ...
    @JsonCreator
    public ShopCreated(@JsonProperty("shopId") @NonNull ShopId shopId,
